module.exports = () => {
  return {
    cardMembership: {
      heading: 'Card Membership Provides Benefits&nbsp;Like:',
      items: [
        {
        ...
        {
          title: 'Car Rental Loss and Damage&nbsp;Insurance<sup>♦</sup>',
          iconClass: 'dls-icon-car',
          content: [
            `Can provide coverage for Damage to or Theft of a Rental Vehicle in a Covered Territory when You use Your Eligible Card to reserve and pay for an Entire Rental and decline the collision damage waiver (CDW) at the Rental Company counter. Please read important exclusions and restrictions. Not all vehicle types or rentals are covered. Coverage is not available for vehicles rented in Australia, Italy, and New Zealand. This product provides secondary coverage and does not include liability&nbsp;coverage.`,
          ],
        },
      ],
    },
