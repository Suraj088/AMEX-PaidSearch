...
module.exports = () => {
  return {
    id: 'lowes-business-rewards-card',
    name: 'Lowe’s Business Rewards&nbsp;Card',
    url: `https://www.americanexpress.com/us/credit-cards/business/business-credit-cards/lowes-credit-cards/30214/`,
    pdpUrl: 'https://www.americanexpress.com/us/credit-cards/business/business-credit-cards/lowes-credit-cards/30214/?linknav=US-Acq-GCP-BusinessCards-ViewAllCards-CardTitle-Lowes',
    ...
    Supplies:true,
    annualFeeSymbols: '¤',
    offerAndBenefitTermsUrl: `https://www.americanexpress.com/us/credit-cards/card-application/apply/prospect/terms/lowes-business-rewards-card/30214-9-0?key=tncBody&rwdFlag=rwd#offer-terms`,
    ...
    greatForTitle: 'Premium value for building trades',
    greatFor: [
      {
        iconKey: 'cashback',
    ...
    welcomeOffer: [
      {
        kind: 'heading-4',
        content: `Get <span class="display-block heading-5 font-weight-bold margin-0">$100</span>`,
      },
      {
        kind: 'p',
    ...
    earningRewards: [
      {
        kind: 'img',
        content: `assets/great-for-lowes-business-rewards-card-1635749061.jpg`,
    ...
    moreBenefits: [
      ...
      {
        kind: 'p',
        content: `5% Off Every Day at Lowe's when you use your Lowe’s Business Credit Card on eligible Lowe's Purchases.<sup>‡</sup>`,
      },
      {
        kind: 'heading-3',
      ...
      {
        kind: 'heading-3',
        content: `Vendor Pay by Bill.com<sup>‡</sup>`,
      },
      {
        kind: 'p',
