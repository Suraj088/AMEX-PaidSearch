...
module.exports = () => {
  return {
    ...
    vacPopOut: [
      ...
      },
      {
        ...
        content: [
          ...
          '<strong>1% Back</strong> on other purchases.<sup>‡</sup>',
        ],
      },
    ],
    quickCompare: [
    ...
    greatFor: [
      ...
      {
        iconKey: 'no-fee',
        label: `<strong>1% Back</strong> on other purchases.<sup>‡</sup>`,
      },
    ],
    welcomeOffer: [
      {
    ...
    moreBenefits: [
      ...
      {
        kind: 'p',
        content: `Get deeper insights on purchases and simplify your expense reconciliation. With enhanced data views, you can see Amazon Business purchases listed item by item in an easily downloadable file from your online statement.<sup>‡</sup>`,
      },
      {
        kind: 'heading-3',
        content: `Amazon Rewards Option`,
      },
      {
        kind: 'p',
        content: `The Amazon Business American Express Card with`,
      },
      {
        kind: 'ul',
        content: [
          '3% Back on the first $120,000 in U.S. purchases at Amazon Business, AWS, Amazon.com and Whole Foods Market each calendar year, 1% Back thereafter',
