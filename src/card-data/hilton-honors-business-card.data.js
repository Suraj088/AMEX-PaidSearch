 ...
 module.exports = () => {
  return {
    ...
    greatFor: [
      {
        iconKey: 'rewards',
        label: `<strong>12X Hilton Honors Bonus Points</strong> for each dollar of eligible purchases charged on your Card directly with a hotel or resort within the Hilton&nbsp;portfolio.<sup>‡</sup>`,
      },
      {
        iconKey: 'point-3x',
        label: `<strong>3X</strong> Hilton Honors Bonus Points for all other eligible purchases on your&nbsp;Card<sup>‡</sup>`,
      },
      {
        iconKey: 'medal',
        label: `Complimentary Hilton Honors Gold&nbsp;status<sup>‡</sup>`,
      },
    ],
    welcomeOffer: [
      {
    ...
    earningRewards: [
      {
        kind: 'img',
        content: `assets/great-for-hilton-honors-business-card-1635749061.jpg`,
        extraClasses: 'border-radius-1',
      },
      {
        kind: 'heading-4',
        content: `Earn Hilton Honors Bonus Points`,
      },
      {
        kind: 'p',
        content: `<strong>12X Points</strong> on purchases made directly with hotels and resorts in the Hilton portfolio<sup>‡</sup>`,
      },
      {
        kind: 'p',
        content: `<strong>6X Points</strong>`,
      },
      {
        kind: 'ul',
        content: [
      ...
      {
        kind: 'p',
        content: `<strong>3X</strong> Points on other purchases<sup>‡</sup>`,
      },
    ],
    moreBenefits: [
      {
      ...
      {
        kind: 'heading-3',
        content: `Priority Pass<sup>TM</sup> Select<sup>‡</sup>`,
      },
      {
        kind: 'p',
