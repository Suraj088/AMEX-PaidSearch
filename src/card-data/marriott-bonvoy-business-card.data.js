...
module.exports = () => {
  return {
    ...
    Shipping:true,
    annualFeeSymbols: '¤',
    offerAndBenefitTermsUrl: `https://www.americanexpress.com/us/credit-cards/card-application/apply/prospect/terms/marriott-bonvoy-business-american-express-card/30214-9-0?key=tncBody&rwdFlag=rwd#offer-terms`,
    ...
    welcomeOffer: [
      {
        kind: 'heading-4',
        content: `Earn <span class="display-block heading-5 font-weight-bold margin-0">75,000</span>`,
      },
      {
        kind: 'p',
        content:
    ...
    earningRewards: [
      {
        kind: 'img',
        content: `assets/great-for-marriott-bonvoy-business-card-1635749061.jpg`,
      ...
      {
        kind: 'p',
        content: `<strong>6X points</strong> for each dollar of eligible purchases at hotels participating in Marriott&nbsp;Bonvoy.<sup>‡</sup>`,
      },
      {
        kind: 'p',
      ...
      {
        kind: 'p',
        content: `<strong>2X points</strong> on all other eligible purchases<sup>‡</sup>`,
      },
    ],
    moreBenefits: [
      {
      ...
      {
        kind: 'heading-3',
        content: `Marriott Bonvoy Air+Car Transfer Program`,
      },
      {
        kind: 'p',
